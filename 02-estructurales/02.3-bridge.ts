...
class AlertNotification extends Notification {
  ...
  override addChannel(channel: NotificationChannel): void {
    console.log("Agregando canal nuevo");
...
function main() {
  ...
  const notifications = new AlertNotification(channels);

  notifications.notify("Notifica a todos que valen verga");
  //   notifications.addChannel(new PushNotificationChannel());
}
